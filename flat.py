...
def prediction():
    ...
    with st.form('resale price'):
        ...
        if Button:
            with open('C:/Users/BharathKrishna.S/OneDrive/Desktop/singapore flat resale/Regression_model.pkl', 'rb') as file:
...
def statistics(): 
    ...
    with col1:
        ...
        metrics={'Metrics':['R2 Score', 'Mean Absolute error', 'Mean Squared error', 'Root Mean Squared error'], 'Values':[0.9563379827797055, 0.05114748039046649, 0.0049171854077286305, 0.07012264547012349]}
